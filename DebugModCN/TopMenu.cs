...
namespace DebugMod
{
    public static class TopMenu
    {
        ...
        public static void BuildMenu(GameObject canvas)
        {
            ...
            //Main buttons
            panel.AddButton("隐藏菜单", GUIController.Instance.images["ButtonRect"], new Vector2(46f, 28f), Vector2.zero, HideMenuClicked, buttonRect, GUIController.Instance.trajanBold, "隐藏菜单");
            panel.AddButton("全杀了", GUIController.Instance.images["ButtonRect"], new Vector2(146f, 28f), Vector2.zero, BindableFunctions.KillAll, buttonRect, GUIController.Instance.trajanBold, "全杀了");
            panel.AddButton("设置重生点", GUIController.Instance.images["ButtonRect"], new Vector2(246f, 28f), Vector2.zero, BindableFunctions.SetHazardRespawn, buttonRect, GUIController.Instance.trajanBold, "设置重生点");
            panel.AddButton("重生", GUIController.Instance.images["ButtonRect"], new Vector2(346f, 28f), Vector2.zero, BindableFunctions.Respawn, buttonRect, GUIController.Instance.trajanBold, "重生");
            panel.AddButton("其他", GUIController.Instance.images["ButtonRect"], new Vector2(446f, 28f), Vector2.zero, () => panel.TogglePanel("Other Panel"), buttonRect, GUIController.Instance.trajanBold, "其他");
            panel.AddButton("作弊", GUIController.Instance.images["ButtonRect"], new Vector2(46f, 68f), Vector2.zero, () => panel.TogglePanel("Cheats Panel"), buttonRect, GUIController.Instance.trajanBold, "作弊");
            panel.AddButton("工具", GUIController.Instance.images["ButtonRect"], new Vector2(146f, 68f), Vector2.zero, () => panel.TogglePanel("Tools Panel"), buttonRect, GUIController.Instance.trajanBold, "工具");
            panel.AddButton("技能", GUIController.Instance.images["ButtonRect"], new Vector2(246f, 68f), Vector2.zero, () => panel.TogglePanel("Skills Panel"), buttonRect, GUIController.Instance.trajanBold, "技能");
            panel.AddButton("物品", GUIController.Instance.images["ButtonRect"], new Vector2(346f, 68f), Vector2.zero, () => panel.TogglePanel("Items Panel"), buttonRect, GUIController.Instance.trajanBold, "物品");
            ...
            panel.AddButton("存档状态", GUIController.Instance.images["ButtonRect"], new Vector2(446f, 68f), Vector2.zero, () => panel.TogglePanel("SaveStates Panel"), buttonRect, GUIController.Instance.trajanBold, "存档状态");
            ...
            //Cheats panel
            cheatsPanel.AddButton("无限血", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 30f), Vector2.zero, BindableFunctions.ToggleInfiniteHP, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "无限血", 10);
            cheatsPanel.AddButton("无限丝", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 60f), Vector2.zero, BindableFunctions.ToggleInfiniteSilk, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "无限丝", 10);
            cheatsPanel.AddButton("无敌", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 90f), Vector2.zero, BindableFunctions.ToggleInvincibility, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "无敌", 10);
            cheatsPanel.AddButton("飞天遁地", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 120f), Vector2.zero, BindableFunctions.ToggleNoclip, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "飞天遁地", 10);
            cheatsPanel.AddButton("无限跳", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 150f), Vector2.zero, BindableFunctions.ToggleInfiniteJump, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "无限跳", 10);
            cheatsPanel.AddButton("自杀", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 180f), Vector2.zero, BindableFunctions.KillSelf, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "自杀", 10);
            cheatsPanel.AddButton("锁定按键绑定", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 210f), Vector2.zero, BindableFunctions.ToggleLockKeyBinds, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "锁定按键绑定", 9);

            //Skills panel buttons
            // TODO: use images instead of text?
            skillsPanel.AddButton("全技能", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 30f), Vector2.zero, BindableFunctions.GiveAllSkills, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "全技能", 10);
            skillsPanel.AddButton("丝之心", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 60f), Vector2.zero, BindableFunctions.IncrementSilkHeart, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "丝之心: " + PlayerData.instance.silkRegenMax, 10);
            skillsPanel.AddButton("疾风步", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 90f), Vector2.zero, BindableFunctions.ToggleSwiftStep, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "疾风步", 10);
            skillsPanel.AddButton("披风", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 120f), Vector2.zero, BindableFunctions.IncrementCloak, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "披风切换", 10);
            skillsPanel.AddButton("蛛攀术", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 150f), Vector2.zero, BindableFunctions.ToggleClingGrip, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "蛛攀术", 10);
            skillsPanel.AddButton("织忆弦针", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 180f), Vector2.zero, BindableFunctions.ToggleNeedolin, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "织忆弦针", 10);
            skillsPanel.AddButton("飞针冲刺", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 210f), Vector2.zero, BindableFunctions.ToggleClawline, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "飞针冲刺", 10);
            skillsPanel.AddButton("灵丝升腾", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 240f), Vector2.zero, BindableFunctions.ToggleSilkSoar, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "灵丝升腾", 10);
            skillsPanel.AddButton("唤兽曲", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 270f), Vector2.zero, BindableFunctions.ToggleBeastlingCall, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "唤兽曲", 10);
            skillsPanel.AddButton("深邃挽歌", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 300f), Vector2.zero, BindableFunctions.ToggleElegyOfTheDeep, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "深邃挽歌", 10);
            skillsPanel.AddButton("蓄力斩", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 330f), Vector2.zero, BindableFunctions.ToggleNeedleStrike, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "蓄力斩", 10);

            //Tools panel
            toolsPanel.AddButton("全工具", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 30f), Vector2.zero, BindableFunctions.UnlockAllTools, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "全工具", 10);
            toolsPanel.AddButton("全纹章", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 60f), Vector2.zero, BindableFunctions.UnlockAllCrests, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "全纹章", 10);
            toolsPanel.AddButton("工具袋容量", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 90f), Vector2.zero, BindableFunctions.IncrementPouches, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "容量: " + PlayerData.instance.ToolPouchUpgrades, 10);
            toolsPanel.AddButton("工具袋伤害", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 120f), Vector2.zero, BindableFunctions.IncrementKits, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "伤害: " + PlayerData.instance.ToolKitUpgrades, 10);
            toolsPanel.AddButton("无限工具", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 150f), Vector2.zero, BindableFunctions.ToggleInfiniteTools, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "无限工具", 10);
            toolsPanel.AddButton("制造新工具", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 180f), Vector2.zero, BindableFunctions.CraftTools, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "制造新工具", 10);

            //Items panel
            itemsPanel.AddButton("念珠", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 30f), Vector2.zero, BindableFunctions.GiveRosaries, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "念珠", 10);
            itemsPanel.AddButton("兽甲碎片", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 60f), Vector2.zero, BindableFunctions.GiveShellShards, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "兽甲碎片", 10);
            itemsPanel.AddButton("忆境纪念盒", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 90f), Vector2.zero, BindableFunctions.GiveMemoryLockets, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "忆境纪念盒", 10);
            itemsPanel.AddButton("制造金属", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 120f), Vector2.zero, BindableFunctions.GiveCraftmetal, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "制造金属", 10);
            itemsPanel.AddButton("噬丝蛆", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 150f), Vector2.zero, BindableFunctions.GiveSilkeater, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "噬丝蛆", 10);
            ...
            //Other Panel
            otherPanel.AddButton("加入Discord", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 30f), Vector2.zero, _ => Application.OpenURL("https://discord.gg/VDsg3HmWuB"), new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "加入Discord", 10);
            otherPanel.AddButton("打开存档目录", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 60f), Vector2.zero, _ => Process.Start(Application.persistentDataPath), new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "存档目录", 10);
            otherPanel.AddButton("打开模组目录", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 90f), Vector2.zero, _ => Process.Start(Directory.GetParent(Path.GetDirectoryName(System.Reflection.Assembly.GetCallingAssembly().Location)).ToString()), new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "模组目录", 10);
            ...
            saveStatesPanel.AddButton("快速存档（储存）", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 30f), Vector2.zero, BindableFunctions.SaveState, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "储存", 8);
            saveStatesPanel.AddButton("快速存档（读取）", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 50f), Vector2.zero, BindableFunctions.LoadState, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "读取", 8);
            saveStatesPanel.AddButton("文件储存", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 80f), Vector2.zero, BindableFunctions.NewSaveStateToFile, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "文件储存", 10);
            saveStatesPanel.AddButton("文件读取", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 100f), Vector2.zero, BindableFunctions.LoadFromFile, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "文件读取", 10);
            saveStatesPanel.AddButton("向左滚动", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(-15f, 115f), Vector2.zero, BindableFunctions.PrevStatePage, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "向左滚动", 8);
            saveStatesPanel.AddButton("向右滚动", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(20f, 115f), Vector2.zero, BindableFunctions.NextStatePage, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "向右滚动", 8);
            saveStatesPanel.AddButton("死亡加载存档", GUIController.Instance.images["ButtonRectEmpty"], new Vector2(5f, 145f), Vector2.zero, BindableFunctions.LoadStateOnDeath, new Rect(0f, 0f, 80f, 20f), GUIController.Instance.trajanNormal, "死亡加载存档", 9);
